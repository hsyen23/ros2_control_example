...
#ifndef MY_CONTROLLER2_HPP_ //<--- remember to change
#define MY_CONTROLLER2_HPP_ //<--- remember to change
...
#include "custom_interfaces/msg/controlnote.hpp" // <--- now we use our custom message

namespace my_controller2 {  //<--- remember to change namesapce
...
class MyController2 : public controller_interface::ControllerInterface {    // <--- remember to change class name
public:
  MyController2();                                                          // construtor
...
protected:
  ...
  using ControllerCommandMsg = custom_interfaces::msg::Controlnote;                 // the type (interface/message) of published command topic
