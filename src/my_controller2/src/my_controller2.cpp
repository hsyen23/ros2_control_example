...
#include "my_controller2/my_controller2.hpp"
...
{
MyController2::MyController2() : controller_interface::ControllerInterface() {} // empty constructor, ros pluginlib require all plugin have empty constructor!
...
// All the methods added must be inside this namespace
    ...
    */
    CallbackReturn MyController2::on_configure(
        ...
        auto callback_command =
            ...
            if (msg->the_joint_names.size() == joint_names_.size()) {
            ...
            RCLCPP_ERROR(get_node()->get_logger(),
                        ...
                        "Ignoring message.",
                        msg->the_joint_names.size(), joint_names_.size());
            }
        };
    ...
    */
    controller_interface::InterfaceConfiguration MyController2::command_interface_configuration() const
    {
    ...
    */
    controller_interface::InterfaceConfiguration MyController2::state_interface_configuration() const
    {
    ...
    */
    CallbackReturn MyController2::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
    {
    // Set default value in command
    std::shared_ptr<ControllerCommandMsg> msg = std::make_shared<ControllerCommandMsg>();
    msg->the_joint_names = joint_names_;
    ...
    */
    CallbackReturn MyController2::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
    {
    return CallbackReturn::SUCCESS;
    }
    ...
    */
    ...
    MyController2::update(const rclcpp::Time &time,
        ...
        for (size_t i = 0; i < command_interfaces_.size(); ++i) {
            ...
            command_interfaces_[i].set_value((*current_command)->values[i]);
...
PLUGINLIB_EXPORT_CLASS(my_controller2::MyController2, controller_interface::ControllerInterface)
