...
class Metaclass_MultiLinkPos(type):
    """Metaclass of message 'MultiLinkPos'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.msg.MultiLinkPos')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__multi_link_pos
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__multi_link_pos
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__multi_link_pos
            cls._TYPE_SUPPORT = module.type_support_msg__msg__multi_link_pos
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__multi_link_pos
...
class MultiLinkPos(metaclass=Metaclass_MultiLinkPos):
    """Message class 'MultiLinkPos'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.controllable = kwargs.get('controllable', [])
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'controllable' field must be a set or sequence and each value of type 'bool'"
